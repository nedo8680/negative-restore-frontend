...
const DigitizeNegative: React.FC = () => {
  ...
  return (
    <div>
      ...
      {/* Bloque superior: zona de carga + resultado (gestionado dentro de UploadForm) */}
      <div className="bg-gray-50 pt-8 pb-10 rounded-xl mt-10 mb-16 shadow-sm">
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        <HelmetProvider>
          ...
          <meta name="description" content={t("digitize.metaDescription")} />
        </HelmetProvider>
